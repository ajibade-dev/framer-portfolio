    ...
    <div className='md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32'>
        ...
        <div className='z-30 basis-2/5 mt-12 md:mt-32'>
            ...
            >
                ...
                <p className='mt-10 mb-7 text-md text-center md:text-start font-opensans'>
                  Hi there, welcome to my portfolio website. I design and develop responsive and eye-catching web interfaces that help to convert visitors to clients.  
                </p>
            </motion.div>
